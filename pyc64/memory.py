...
class ScreenAndMemory:
    ...
    def __init__(self, columns=40, rows=25, sprites=8, rom_directory="", run_real_roms=False):
        ...
        self.reset(True)
        self.install_memory_hooks(run_real_roms)

    def install_memory_hooks(self, run_real_roms):
    ...
    def reset(self, hard=False):
        ...
        self.memory[56320] = 0b10000000   # joystick port 2
        self.memory[56321] = 0b11111111   # joystick port 1 (not used)
        self.clear()
    ...
    def writestr(self, txt):
        ...
        self.write(self.encode_petscii(txt))

    def encode_petscii(self, text):
        """Convert ASCII text to PETSCII bytes"""
        try:
            return bytes(text, "petscii-c64en-lc", "pyc64specials")
